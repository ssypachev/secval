...
describe('Should test compounder', () => {
    it('should just create compounder', () => {
        let [err, options] = new Validator().arg('a', 5).required.int.compound.build();
    });
    ...
    it('should test allornothing compounder', () => {
        ...
        let [err, options] = new Validator()
            ...
            .optional.int.arg('b')
            .optional.int.arg('c')
            .optional.int.compound.allOrNothing('a', 'b', 'c')
            .build();
        ...
        try {
            [err, options] = new Validator()
                ...
                .optional.int.arg('b')
                .optional.int.arg('c')
                .optional.int.compound.allOrNothing('a')
                .build();
        } catch (err) {
            flag = true;
        }
    ...
    it('should test nested compounder', () => {
        let [err, options] = new Validator()
            ...
            .optional.float.end.compound.allOrNothing('location.latitude', 'location.longitude')
            .build();
