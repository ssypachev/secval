...
describe("Should test float validator", () => {
	...
	it ("Should test simple strict float alias", () => { 
		...
		let [err, options] = new Validator().with(arg)
		.arg("a").required.strict.float.build();
	...
	it ("Should fail simple optional float", () => { 
		...
		let [err, options] = new Validator().with(arg)
		.arg("a").optional.default("some").ofType("float").build();
	...
	it ("Should test simple optional float", () => { 
		...
		let [err, options] = new Validator().with(arg)
		.arg("a").optional.default(-13.24).ofType("float").build();
	...
	it ("Should test float, max", () => { 
		...
		let [err, options] = new Validator().with(arg)
		.arg("a").required.ofType("float").max(15).build();
		...
		[err, options] = new Validator().with(arg)
		.arg("a").required.ofType("float").max(10).build();
	...
	it ("Should test float, min", () => { 
		...
		let [err, options] = new Validator().with(arg)
		.arg("a").required.ofType("float").min(10).build();
		...
		[err, options] = new Validator().with(arg)
		.arg("a").required.ofType("float").min(15).build();
	...
	it ("Should test float, between", () => { 
		...
		let [err, options] = new Validator().with(arg)
		.arg("a").required.ofType("float").between(1, 15).build();
		...
		[err, options] = new Validator().with(arg)
		.arg("a").required.ofType("float").between(1, 2).build();
